...
execution_updated_at: "2026-09-25T15:53:59Z"
...
| 2026-09-22T14:29:41Z | PLAN-00007-STEP-12 | User-directed fix outside the approved plan: review 00011 (file docs/reviews/00011-Release_V2_Rc2_Code_Review.md) REV-00011-MED-01, the migration recipe copying the legacy zero maximum-tweak sentinel. Verified against the pinned oracle: ubiq_security_fpe applies its maximum only when positive (ffx.py:48, ff1.py:37), so twk_max_len=0 means unbounded there, while max_tweak_len=0 here means empty-only. Reproduced: the documented recipe with legacy (0,0) and a non-empty tweak raises TweakLengthError at construction while the legacy context encrypts the same configuration | README API mapping, table row and new behaviour-change note 5; the same example in tests/test_interoperability.py's docstring; new test_documented_migration_recipe_accepts_what_the_legacy_context_accepted (both backends, legacy (0,0) and (4,8), encrypt/decrypt/per-call tweak); new test_max_tweak_len_zero_means_empty_tweaks_only pinning the literal meaning | Checkpoint, then disposition in the STEP-12 review |
| 2026-09-25T15:44:35Z | PLAN-00007-STEP-12 | Work-log reference corrected per REV-00012-LOW-01: the migration finding is REV-00011-MED-01 (review 00011), not REV-00010-MED-01; review 00010 holds only REV-00010-LOW-01. Two occurrences in this log fixed | Identifier verified against docs/reviews/00010-Full_Codebase_Review_6fd3548.md and docs/reviews/00011-Release_V2_Rc2_Code_Review.md | Close STEP-12 |
| 2026-09-25T15:44:35Z | PLAN-00007-STEP-12 | Dispositions of every finding still open across reviews 00010 to 00014: REV-00012-LOW-01 fixed in this update. REV-00010-LOW-01 (stale backlog line) fixed in STEP-13. REV-00013-MED-01 (plan 00008 D8 declares MSRV 1.87 while rust/fpr-ff1-rust/src/lib.rs:112 uses slice::as_chunks, stable 1.88) accepted and deferred: it concerns plan 00008, which is approved but not started and gated behind v2.0.0 by D7, and needs a plan revision or an authorised switch to chunks_exact before STEP-01; no effect on the v2.0.0 artifacts (rust-toolchain.toml pins the stable channel). REV-00011-LOW-01 (released memoryview raises ValueError outside FF1Error), REV-00011-LOW-02 (test_tweak_sensitivity cannot fail), REV-00011-LOW-03 (concurrency tests keep only the last of 20 iterations) accepted and deferred past 2.0.0 by user decision | Verified independently: as_chunks at lib.rs:112; the three 00011 Lows re-read at HEAD and still present | STEP-13 |
| 2026-09-25T15:44:35Z | PLAN-00007-STEP-13 | Final bump: pyproject.toml and rust/fpr-ff1-rust/Cargo.toml to 2.0.0; uv.lock and rust/Cargo.lock refreshed; CHANGELOG [2.0.0] dated 2026-09-25 with the rc sections intact and links added; README roadmap row now says 'Shipped in 2.0.0'; SECURITY.md support date filled; docs/backlog.md records the release as Completed and tracks plan 00008 | Contract test red after the first manifest bump (Version('2.0.0rc2') != Version('2.0.0')), green after the second; lock diffs are exactly the project version line in each file; support window date = tag date 2026-09-25 plus six calendar months = 2027-03-25 | Gate the final commit |
...
| 2026-09-22T14:29:42Z | PLAN-00007-STEP-12 | This fix is not in the approved plan: it comes from review 00011's Medium finding and was directed by the user before the STEP-12 review is dispositioned. Docs plus tests only; no src/ or rust/ change, so the rc2 artifacts are unaffected | The final release will carry a README, interoperability docstring and two tests that rc2 does not. The STEP-12 review should disposition REV-00011-MED-01 against this commit | None; recorded for the re-review and the STEP-13/14 release notes |
| 2026-09-25T15:44:35Z | PLAN-00007-STEP-13 | AC-12 and the STEP-13 verification ask for 'grep -rn "<v2.0.0 date" .' to be empty. That cannot be satisfied literally: the placeholder string is quoted in this plan's approved planning content and in immutable review reports, neither of which Builder may edit | None on the release. The criterion's intent -- no unfilled placeholder in anything shipped or published -- is met and verified by the narrower grep recorded above | None; recorded for the release review |
...
| 2026-09-22T14:29:41Z | PLAN-00007-STEP-12 | Red-then-green on the new migration test: helper reverted to max_tweak_len=twk_max_len, then restored | Pass | Reverted: TweakLengthError 'tweak length 5 above maximum 0' in the legacy-unbounded case. Restored: 4 passed |
| 2026-09-22T14:29:41Z | PLAN-00007-STEP-12 | static checks; just rust-test; just rust-lint; full dual-backend gate; just quality Rust-free | Pass | 1688 passed in 258.01s, 100% coverage, -k rust 576/1688; Rust-free 872 passed, 245 skipped, 100%; cargo test 16 passed; logs checkpoint-142118 |
| 2026-09-25T15:44:35Z | PLAN-00007-STEP-12 | Three independent re-reviews at HEAD 0fe89ea, branch mode (merge-base(origin/main, release/v2)..release/v2) | Pass (no Critical or Major) | 00012 (ollama-cloud/deepseek-v4.1-flash) approve, 1 Low; 00013 (openai/gpt-6-astra) approve-with-comments, 1 Medium; 00014 (zai-coding-plan/glm-5.3) approve, 0 findings. All three classify REV-00007-MAJ-01, MED-01, MED-02 and LOW-01 as resolved from their own source inspection, and all three re-confirm REV-00011-MED-01 resolved by 0fe89ea. Earlier at the same code: 00010 approve (1 Low), 00011 approve-with-comments (1 Medium, 3 Low) |
| 2026-09-25T15:44:35Z | PLAN-00007-STEP-13 | NIST SP 800-38G Rev. 1 status re-checked at final freeze (csrc.nist.gov, fetched 2026-09-25) | Pass (no change) | Still the 2nd Public Draft published 2025-02-03; comment period closed 2025-04-04; no final publication and no withdrawal. Documented baseline, radix subset, no-float and forward-AES rules retained |
